...
export default function NewPostTile({
  ...
  return (
    <>
      <div className="flex flex-col items-start gap-6 rounded transition-all duration-100 md:flex-row md:gap-8 md:p-4 md:hover:cursor-pointer md:hover:bg-brand-10">
        <Image
